...
public class InventoryServiceTest {
    ...
    @Test void getTowerListNotFirstTime(){
        ...
        Tower heavyGold = new Tower(TowerGenerator.heavyTowerHealthGenerator(),false, "Gold", TowerGenerator.heavyTowerFillAmountGenerator(),  TowerGenerator.heavyTowerReloadSpeedGenerator(), "Heavy Gold", 1.5,TowerGenerator.heavyTowerPriceGenerator(1.5));
        Tower lightGold = new Tower(TowerGenerator.lightTowerHealthGenerator(),false, "Gold", TowerGenerator.lightTowerFillAmountGenerator(),  TowerGenerator.lightTowerReloadSpeedGenerator(), "Light Gold", 1.5,TowerGenerator.lightTowerPriceGenerator(1.5));
        Tower lightGem = new Tower(TowerGenerator.heavyTowerHealthGenerator(),false, "Gem", TowerGenerator.heavyTowerFillAmountGenerator(),  TowerGenerator.heavyTowerReloadSpeedGenerator(), "Test Light Gem", 1.5,TowerGenerator.heavyTowerPriceGenerator(1.5));
        Tower heavyGem = new Tower(TowerGenerator.lightTowerHealthGenerator(),false, "Gem", TowerGenerator.lightTowerFillAmountGenerator(),  TowerGenerator.lightTowerReloadSpeedGenerator(), "Test Heavy Gem", 1.5,TowerGenerator.lightTowerPriceGenerator(1.5));
